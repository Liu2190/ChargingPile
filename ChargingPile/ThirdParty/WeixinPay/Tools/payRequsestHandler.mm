...
//    //订单标题，展示给用户
//    NSString *order_name    = order_name;
//    //订单金额,单位（分）
//    NSString *order_price   = @"1";//1分钱测
    ...
    [packageParams setObject: @"101.200.142.29"    forKey:@"spbill_create_ip"];//发器支付的机器ip
